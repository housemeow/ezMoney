...
namespace ezMoney
{
    class RecordViewProperty
    {
        ...
        public DataGridView DataGridViewRecord
        {
            ...
            set
            {
                _dataGridViewRecord = value;
            }
        }

        public CurrencyManager CurrencyManagerCategoryList
        {
            get
            {
            ...
            set
            {
                _currencyManagerComboBox = value;
            }
        }

        public CurrencyManager CurrencyManagerRecordList
        {
            get
            {
            ...
            set
            {
                _currencyManagerDataGridView = value;
            }
        }
